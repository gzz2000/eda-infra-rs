...
module aes256(VGND, VPWR, clk, key, out, state);
  ...
  assign long_wire = {128'b11111100110000100100011010101000001100100001001011100101101101100101101110110000111011101101100100010010111111010010101110011010, 128'b11011110101011011011xxxxxxxx1111000100111000001111000000100110100101100000011000001000001110110000101101001111100100100001001101};
